...
public class GuruActivity extends Activity implements View.OnClickListener{
...
//              .show();
      ...
      status = (TextView) findViewById(R.id.statusGRU);
      status.setText(Html.fromHtml("Welcome,<b>" + nama + "</b>  "));
      status.setOnClickListener(this);

      logout = (Button) findViewById(R.id.logoutGRU);
    ...
    //Get ID tombol & Event Tombol
		btnJadwal= (Button) findViewById(R.id.btn_jadwalGRU);
		btnJadwal.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Intent jadwal = new Intent(GuruActivity.this, ViewAllJadwal.class);
